...
public class CsvUtils {
    ...
    private static final CSVFormat ORDERS_CSV_FORMAT = CSVFormat.DEFAULT
            .builder()
            .setHeader("insuranceId", "userId", "createdAt")
            .setSkipHeaderRecord(true)
            .build();
    private static final CSVFormat POLICE_INCIDENTS_CSV_FORMAT = CSVFormat.DEFAULT;
    ...
    public static void writeOrdersToCsv(List<OrderCsvDto> orders) {
        ...
        try (Writer writer = new FileWriter(file);
             CSVPrinter csvPrinter = new CSVPrinter(writer, ORDERS_CSV_FORMAT)) {
    ...
    public static List<OrderCsvDto> readOrdersFromCsv() {
        ...
        try (Reader reader = new FileReader(CSV_FILE_CONTENT_PATH);
             CSVParser csvParser = new CSVParser(reader, ORDERS_CSV_FORMAT)) {
